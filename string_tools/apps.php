...
<body>
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <h3 class="text-center my-5">String Manipulation Tools</h3>
        <div class="card">
          <div class="card-header">
            ...
            if (isset($stringInput) && isset($stringFunction)){
                switch ($stringFunction) {
                  case 'strlen':
                    $result = strlen($stringInput);
                    break;
                  case 'strrev':
                    $result = strrev($stringInput);
                    break;
                  case 'strtoupper':
                    $result = strtoupper($stringInput);
                    break;
                  case 'strtolower':
                    $result = strtolower($stringInput);
                    break;
                  case 'ucfirst':
                    $result = ucfirst($stringInput);
                    break;
                  case 'ucwords':
                    $result = ucwords($stringInput);
                    break;
                  case 'trim':
                    $result = trim($stringInput);
                    break;
                  case 'str_repeat':
                    $result = str_repeat($stringInput, 3);
                    break;
